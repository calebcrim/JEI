...
export const peopleRoles: Record<string, string> = {
  ...
  'mark-epstein': `Mark Epstein, Jeffrey's brother, was a beneficiary of the estate and
    maintained financial connections to the property infrastructure. He owned and managed
    apartments in a building connected to Jeffrey's real estate holdings. His role in the
    broader financial architecture of the operation remains a subject of ongoing scrutiny,
    though he has not been charged with any crimes.`,

  'lesley-groff': `Groff was Epstein's executive assistant and scheduler, appearing in
    157,613 EFTA documents — more than almost any other individual in the case. She managed
    appointments, travel logistics, and communications for Epstein's network over decades.
    She received immunity under the 2008 NPA and has not cooperated with subsequent
    investigations. Her central administrative role means she was likely aware of scheduling
    patterns now documented as trafficking logistics.`,

  'adriana-ross-ne-adriana-mucinska': `Ross (née Mucinska) was brought from Poland and became
    part of Epstein's inner circle. She received immunity under the 2008 NPA as a named
    co-conspirator. She was involved in passport handling and property logistics. Like Kellen
    and Marcinkova, she represents one of the immunity recipients whose continued freedom
    without accountability is cited as evidence of the NPA's extraordinary scope.`,

  'peter-listerman': `Listerman was a Russian model scout who appeared in FBI investigative
    diagrams as part of the international recruitment network. He operated in the model
    industry pipeline that overlapped with Brunel's MC2 operations, facilitating introductions
    between young women and wealthy men. His role connects the trafficking operation to its
    Eastern European procurement dimension.`,

  'richard-kahn': `Kahn served as Epstein's accountant and co-executor of his estate,
    appearing in 52,781 EFTA documents. He managed the financial infrastructure alongside
    Indyke and was involved in the $35 million settlement fund. He administered transactions
    through shell entities and trust structures that are now subjects of forensic financial
    investigation.`,

  'juan-alessi': `Alessi was the house manager at Epstein's Palm Beach estate and one of the
    most detailed witnesses regarding day-to-day operations. He testified about the constant
    presence of young women at the property, the massage schedule, and the household rules.
    His testimony in the Maxwell trial provided granular detail about the operational logistics
    of the trafficking at the Palm Beach residence.`,

  'alfredo-rodriguez': `Rodriguez was a house manager at Epstein's Palm Beach estate who
    became an FBI informant. He attempted to sell Epstein's "black book" — a detailed contact
    directory — and was convicted of obstruction of justice for failing to turn it over
    properly. He died of mesothelioma in 2015. His cooperation, though legally complicated,
    produced some of the earliest corroborating evidence of the trafficking operation's scope.`,

  'haley-robson': `Robson was a victim who was recruited by Epstein's operation and subsequently
    became a recruiter of other underage girls, illustrating the pyramid-like recruitment
    structure that Maxwell designed. She was paid $200 per girl she brought to Epstein's Palm
    Beach estate. Her trajectory from victim to recruiter is one of the documented patterns
    of how the operation sustained itself.`,
};
